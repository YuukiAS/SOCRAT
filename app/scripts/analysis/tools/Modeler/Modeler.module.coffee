...
module.exports = modeler = new Module
  ...
  components:
    services:
      ...
      'socrat_modeler_distribution_normal': require 'scripts/analysis/tools/Modeler/ModelerDistributionNormal.service.js'
      ...
      'app_analysis_modeler_hist': require 'scripts/analysis/tools/Modeler/ModelerHistPlot.service.js'
    ...
    controllers:
      ...
      'modelerSidebarCtrl': require 'scripts/analysis/tools/Modeler/ModelerSidebarCtrl.ctrl.js'

    directives:
      'modelerVizDir': require 'scripts/analysis/tools/Modeler/ModelerVizDir.directive.js'
